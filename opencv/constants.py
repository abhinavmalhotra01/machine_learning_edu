...
# In this case, the image array has a shape of (512, 512, 3), where:
# The first dimension (512) represents the height of the image.
# The second dimension (512) represents the width of the image.
# The third dimension (3) represents the number of color channels.